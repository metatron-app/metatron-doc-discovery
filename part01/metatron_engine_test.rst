...
.. figure:: /_static/img/part01/druid-mysql-benchmark.png
   :align: center
...
.. figure:: /_static/img/part01/druid-scaling-benchmark.png
   :align: center
...
.. figure:: /_static/img/part01/druid-ingestion-test.png
   :align: center
...
.. figure:: /_static/img/part01/druid-mysql-benchmark2.png
   :align: center
   :alt: Druid와 MySQL 벤치마크(100GB TPC-H 데이터셋)

* Hive의 benchmark가 현저하게 떨어지는 원인 중 일부는 Thrift로 측정한 것과 partition없이 test set이 구성되어 있기 때문임
