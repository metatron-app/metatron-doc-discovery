...
export METATRON_MEM="-Xms512m -Xmx512m -XX:MaxMetaspaceSize=256m"           		# metatron jvm mem options Default -Xms1024m -Xmx1024m -XX:MaxMetaspaceSize=512m
...
export METATRON_DB_TYPE=mysql               # h2 or mysql. h2 by default
